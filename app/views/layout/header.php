...
<head>
    ...
    <link rel="stylesheet" href="/Marrakech%20Food%20Lovers/app/public/css/style.css">
</head>
<body>
    <header class="navbar">
        <div class="navbar-container">
            ...
            <nav class="navbar-nav">
                ...
                <?php else: ?>
                    <a href="/Marrakech%20Food%20Lovers/users/login" class="nav-link">Login</a>
                    <a href="/Marrakech%20Food%20Lovers/users/register" class="nav-link nav-link-active">Register</a>
                <?php endif; ?>
            </nav>
        </div>
    </header>
